...
class ChatPageRate extends StatelessWidget{
  ChatPageRate ({Key? key, this.picChat, this.nameChat, this.descriptionChat}): super(key: key);
  String? picChat;
  String? nameChat;
  String? descriptionChat;
  static const String routeName = '/ChatPageRate';
