...
class ProfileUploadPhotoPage extends StatefulWidget{
  ProfileUploadPhotoPage ({Key? key}): super(key: key);
  static const String routeName = '/ProfileUploadPhotoPage';

  @override
  State<ProfileUploadPhotoPage> createState() => _ProfileUploadPhotoPage();
}

class _ProfileUploadPhotoPage extends State<ProfileUploadPhotoPage> {
                  ...
                  child: Column(
                    ...
                    children: [
                      Image(
                        ...
                        image: AssetImage("assets/img/TakePhoto.png"),
                        width: 100,
                        height: 100,
                      ),
                      const SizedBox(height: 10),
