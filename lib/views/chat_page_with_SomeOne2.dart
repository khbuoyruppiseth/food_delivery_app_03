...
class ChatPageWithSomeOne2 extends StatelessWidget{
  ChatPageWithSomeOne2 ({Key? key, this.picChat, this.nameChat, this.descriptionChat,this.mySMS}): super(key: key);
  String? picChat;
  String? nameChat;
